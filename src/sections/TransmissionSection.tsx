  ...
  return (
    ...
    >
      <div className="max-w-2xl">
        <SectionHeader eyebrow={t.transmission.eyebrow} title={t.transmission.title} />
        ...
        >
          <p className="font-mono text-[10px] text-static-gray tracking-widest">
            {t.transmission.copyright.replace('{year}', String(new Date().getFullYear()))}
          </p>
          <p className="font-mono text-[10px] text-static-gray tracking-widest">
            {t.transmission.systemBuild}
          </p>
        </div>
      </div>
    </section>
